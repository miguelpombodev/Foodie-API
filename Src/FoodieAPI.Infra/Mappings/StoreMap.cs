...
namespace FoodieAPI.Infra.Mappings
{
  public class StoreMap : IEntityTypeConfiguration<Store>
  {
    public void Configure(EntityTypeBuilder<Store> builder)
    {
      ...
      builder.Property(x => x.Avatar).HasColumnName("Avatar").HasColumnType("NVARCHAR").HasMaxLength(150).IsRequired();
      ...
      builder.Property(x => x.Address).HasColumnName("Address").HasColumnType("NVARCHAR").HasMaxLength(1000).IsRequired();
